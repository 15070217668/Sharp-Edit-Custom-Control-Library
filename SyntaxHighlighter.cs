...
namespace secl
{
    public class SyntaxHighlighter : IDisposable
    {
        ...
        public readonly Style MagentaStyle = new TextStyle(new SolidBrush(ColorTranslator.FromHtml("#1C99A2")), null, FontStyle.Regular);
        public readonly Style MagentaStyle2 = new TextStyle(Brushes.Magenta, null, FontStyle.Regular);
        ...
        Style DodgerBlue = new TextStyle(new SolidBrush(ColorTranslator.FromHtml("#CB1111")), null, FontStyle.Regular);
        Style SteelBlue = new TextStyle(Brushes.SteelBlue, null, FontStyle.Regular);
        Style DarkGoldenRodBold = new TextStyle(Brushes.Black, null, FontStyle.Regular);
        Style SlateGray = new TextStyle(Brushes.Black, null, FontStyle.Regular);
        Style DarkViolet = new TextStyle(new SolidBrush(ColorTranslator.FromHtml("#1C99A2")), null, FontStyle.Regular);
        ...
        protected void RestoreBrackets(SharpControl tb, char[] oldBrackets)
        {
        ...
        protected char[] RememberBrackets(SharpControl tb)
        {
...
";
        ...
        public virtual void HTMLSyntaxHighlight(Range range)
        {
            ...
            CSSAutoIndentNeeded(range);
            JScriptSyntaxHighlight(range);
            range.SetFoldingMarkers("<html", "</html>", RegexOptions.Multiline);
            ...
            range.SetFoldingMarkers("<style", "</style>", RegexOptions.IgnoreCase);
            range.SetFoldingMarkers("<script", "</script>", RegexOptions.IgnoreCase);
            range.SetFoldingMarkers("<\x0", "</\x0", RegexOptions.Multiline);
        }
