...
namespace secl
{
    ...
    public abstract class Style : IDisposable
    {
        ...
        /// Occurs when user click on StyleVisualMarker joined to this style 
        /// </summary>
        public virtual void OnVisualMarkerClick(SharpControl tb, VisualMarkerEventArgs args)
        {
        ...
        /// </summary>
        protected virtual void AddVisualMarker(SharpControl tb, StyleVisualMarker marker)
        {
        ...
        public override void Draw(Graphics gr, Point position, Range range)
        {
            ...
            using(var f = new Font(range.tb.Font, FontStyle))
            {
                ...
                if (range.tb.ImeAllowed)
                {
                    ...
                    {
                        SizeF size = SharpControl.GetCharSize(f, line[i].c);
    ...
    public class SelectionStyle : Style
    {
        ...
        public override void Draw(Graphics gr, Point position, Range range)
        {
            ...
            if (BackgroundBrush != null)
            {
                ...
                if (rect.Width == 0)
                    return;
                gr.FillRectangle(new SolidBrush(Color.FromArgb(51, Color.FromArgb(0, 180,204))), rect);
                //
    ...
    public class MarkerStyle : Style
    {
        ...
        public override void Draw(Graphics gr, Point position, Range range)
        {
            ...
            if (BackgroundBrush != null)
            {
                ...
                if (rect.Width == 0)
                    return;
                gr.FillRectangle(new SolidBrush(Color.FromArgb(51, Color.FromArgb(0, 180, 204))), new Rectangle(rect.X, rect.Y, range.tb.CharWidth, rect.Height));
            }
        }
