...
namespace secl
{
    ...
    {
        protected SharpControl tb;
        protected List<Bookmark> items = new List<Bookmark>();
        protected int counter;

        public Bookmarks(SharpControl tb)
        {
            this.tb = tb;
    ...
    /// <summary>
    /// Bookmark of SharpControl
    /// </summary>
    public class Bookmark
    {
        public SharpControl TB { get; private set; }
        /// <summary>
        /// Name of bookmark
        /// </summary>
        ...
        public Bookmark(SharpControl tb, string name, int lineIndex)
        {
            this.TB = tb;
            this.Name = name;
