...
namespace secl
{
    ...
    public class Range : IEnumerable<Place>
    {
        Place start;
        Place end;
        public readonly SharpControl tb;
        int preferedPos = -1;
        int updating = 0;
        ...
        /// Constructor
        /// </summary>
        public Range(SharpControl tb, int iStartChar, int iStartLine, int iEndChar, int iEndLine)
            : this(tb)
        {
        ...
        /// Constructor
        /// </summary>
        public Range(SharpControl tb, Place start, Place end)
            : this(tb)
        {
            this.start = start;
            this.end = end;
        ...
        /// </summary>
        public Range(SharpControl tb, int iLine)
            : this(tb)
        {
        ...
        /// SharpControl.Selection range. So, if you want to set text, you need to use SharpControl.Selection
        /// and SharpControl.InsertText() mehtod.
        /// </remarks>
