...
namespace secl
{
    ...
    public class CollapseFoldingMarker: VisualMarker
    {
        ...
        public void Draw(Graphics gr, Pen pen, Brush backgroundBrush, Pen forePen)
        {
            ...
            gr.FillPath(new SolidBrush(Color.White), Style.GetRoundedRectangle(rectangle, 2));
            gr.DrawPath(new Pen(ColorTranslator.FromHtml("#bcbcbc")), Style.GetRoundedRectangle(rectangle, 2));
            gr.DrawLine(new Pen(ColorTranslator.FromHtml("#bcbcbc")), rectangle.Left + 2, rectangle.Top + rectangle.Height / 2, rectangle.Right - 2, rectangle.Top + rectangle.Height / 2);
        }
    }
    ...
    public class ExpandFoldingMarker : VisualMarker
    {
        ...
        public void Draw(Graphics gr, Pen pen,  Brush backgroundBrush, Pen forePen)
        {
            ...
            gr.DrawPath(new Pen(ColorTranslator.FromHtml("#bcbcbc")), Style.GetRoundedRectangle(rectangle, 2));
            gr.DrawLine(new Pen(ColorTranslator.FromHtml("#bcbcbc")), rectangle.Left + 2, rectangle.Top + rectangle.Height / 2, rectangle.Right - 2, rectangle.Top + rectangle.Height / 2);
            gr.DrawLine(new Pen(ColorTranslator.FromHtml("#bcbcbc")), rectangle.Left + rectangle.Width / 2, rectangle.Top + 2, rectangle.Left + rectangle.Width / 2, rectangle.Bottom - 2);
        }
    }
    ...
    public class FoldedAreaMarker : VisualMarker
    {
        ...
        {
            gr.DrawPath(new Pen(ColorTranslator.FromHtml("#bcbcbc")), Style.GetRoundedRectangle(rectangle, 5));
        }
    }
