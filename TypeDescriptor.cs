...
{
    ///
    /// These classes are required for correct data binding to Text property of SharpControl
    /// 
    ...
    class FooTextChangedDescriptor : EventDescriptor
    {
        ...
        {
            (component as SharpControl).BindingTextChanged += value as EventHandler;
        }

        public override Type ComponentType
        {
            get { return typeof(SharpControl); }
        }
